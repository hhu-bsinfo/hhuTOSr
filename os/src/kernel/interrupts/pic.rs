 ...
 * Module: pic
 *
 * Description: The PIC allows to enable or disable IRQs. This determines
 *              whether an interrupt from a device is forwarded to the cpu
 ...
 *              functions in the 'cpu.rs' module.
 *
 * Author: Michael Schoetter, Univ. Duesseldorf, 7.3.2022
 *         Fabian Ruhland, Univ. Duesseldorf, 31.7.2025
 */
